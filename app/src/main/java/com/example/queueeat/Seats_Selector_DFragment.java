...
public class Seats_Selector_DFragment extends Fragment {

    private List<CheckBox> checkBoxList = new ArrayList<>();
    int currSeat;
    public Seats_Selector_DFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_seats__selector__d, container, false);
        ...
        FirebaseUtils.setDataToButtons(FirebaseFirestore.getInstance(), 25, 32, v);
        return v;
    }
    ...
    private void populateCheckBoxList(View rootView) {
        ...
        checkBoxList.add(rootView.findViewById(R.id.checkbox25));
        checkBoxList.add(rootView.findViewById(R.id.checkbox26));
        checkBoxList.add(rootView.findViewById(R.id.checkbox27));
        checkBoxList.add(rootView.findViewById(R.id.checkbox28));
        checkBoxList.add(rootView.findViewById(R.id.checkbox29));
        checkBoxList.add(rootView.findViewById(R.id.checkbox30));
        checkBoxList.add(rootView.findViewById(R.id.checkbox31));
        checkBoxList.add(rootView.findViewById(R.id.checkbox32));
